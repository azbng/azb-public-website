...
import { LogIn, LogOut, LayoutDashboard, Sun, Menu, X, ShieldCheck } from "lucide-react";
...
const links = [
  { to: "/subsidiaries/solar", label: "Overview", end: true },
          ...
          {user ? (
            <>
              <span className="hidden sm:inline text-xs text-muted-foreground">
                {user.fullName} {user.role === "admin" && <span className="ml-1 text-primary">(admin)</span>}
              </span>
